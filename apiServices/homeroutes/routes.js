...
router.get( "/homesidebar", controller.getSidebarItems );

// se envia la informacion de usuarios si se tiene permiso
router.post( "/Usuarios"    ,controller.getUsers       );
router.post( "/Vehiculos"   ,controller.getVehicles    );
router.post( "/Alertas"     ,controller.getAlertas     );
/*
